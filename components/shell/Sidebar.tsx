...
export function Sidebar({ mobileOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 h-full w-[240px] md:w-[220px] bg-white border-r border-clinical-border flex flex-col z-50 transition-transform duration-200 ease-in-out",
      ...
      >
        ...
        <div className="px-5 py-4 border-b border-clinical-border flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="md:hidden p-1 text-clinical-muted hover:text-clinical-navy rounded-lg"
